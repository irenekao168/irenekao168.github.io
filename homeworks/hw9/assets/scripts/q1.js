...
function redButtonClicked() {
    ...
    return setBackgroundColor("EF476F");
...
function yellowButtonClicked() {
    return setBackgroundColor("FFD166");
}
...
function greenButtonClicked() {
    return setBackgroundColor("06D6A0");
}
...
function lightblueButtonClicked() {
    return setBackgroundColor("118AB2");
}
...
function blueButtonClicked() {
    return setBackgroundColor("073B4C");
}
